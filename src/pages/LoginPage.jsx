...
const LoginPage = () => {
    ...
    const handleGoogleLogin = async () => {
        try {
            ...
            toast.success("Welcome back!", { id: "google-login-toast" });
            navigate(from, { replace: true });
        } catch (err) {
            toast.error("Google login failed", { id: "google-login-toast" });
        }
    };
    ...
    return (
        <div className="max-w-md mx-auto mt-12 bg-white p-8 rounded-xl shadow-lg border border-neutral-200">
            ...
            <div className="flex flex-col items-center mb-6">
                <ChefHat size={48} className="text-primary-600 mb-2" />
                <h2 className="text-3xl font-bold text-neutral-800 font-serif">Welcome Back</h2>
                <p className="text-neutral-500">Sign in to continue your culinary journey</p>
            </div>
